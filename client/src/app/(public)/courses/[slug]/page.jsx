...
export default function CourseSinglePage() {
  ...
  const { data: instructor, isLoading: instructorLoading } = useInstructorById(
    course?.instructor
  );
  ...
  if ((courseLoading, instructorLoading, unitsLoading))
    return <CourseSingleSkeleton />;
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            <section className="bg-white shadow-sm rounded-[var(--radius-card)] p-6 mb-6">
              <h2 className="text-xl font-semibold text-[var(--color-secondary)] mb-3">
                Overview
              </h2>
          ...
          <aside className="w-full lg:w-80 flex-shrink-0 lg:sticky lg:top-18 self-start">
            ...
            {/* Includes */}
            <div className="bg-white rounded-[var(--radius-card)] shadow-md p-6 mb-6">
              <h4 className="font-semibold text-[var(--color-secondary)] mb-3">
                Includes
              </h4>
