  ...
  const funds = [
    {
      ...
      description:
        "Fund innovative projects that address the 17 Sustainable Development Goals in our community",
      icon: FaRocket,
    ...
    },
    {
      ...
      title: "Student Fund",
      description:
        "Provide scholarships and financial aid to deserving students pursuing SDG-related studies",
    ...
    },
    {
      ...
      description:
        "Support our annual education festival that promotes SDG awareness and youth engagement",
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-emerald-50">
        <Head>
          ...
          <meta
            name="description"
            content="Contribute to Sustainable Development Goals projects, student funds, and educational initiatives"
          />
        </Head>
